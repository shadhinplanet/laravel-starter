...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend/assets/img/fav-se.png') }}">
    ...
    <link href="{{ asset('backend/') }}/assets/css/dev.css?ts={{ time() }}" rel="stylesheet" type="text/css" />
