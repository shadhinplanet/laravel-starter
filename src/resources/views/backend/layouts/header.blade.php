                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <div style="background-image:url({{ getAssetUrl(auth()->user()->photo,'profile') }});background-size:cover;background-position:center" class="rounded-circle header-profile-user"></div>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="javascript:void(0)" type="submit" class="dropdown-item"><i
                                class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle" data-key="t-logout"
                                onclick="logout({{ auth()->user()->id }})">Logout</span></a>

                        <form id="logout-form-{{ auth()->user()->id }}" action="{{ route('logout') }}"
